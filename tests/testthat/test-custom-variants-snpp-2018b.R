# README ----
# 1 rank custom variants by total population within each LA
# (for year == test_yr) and test against ranking of npp variants for total
...
# 2 compare total population by LA (for year == test_yr) for custom variants
# that also appear in original snpp variant set
test_yr <- "2040"
...
ggsave("test_custom_variants_snpp.png", plot = p, path = here("figures"))
